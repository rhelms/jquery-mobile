...
<head>
	...
	<title>RTL Flip Toggle Switch - jQuery Mobile Demos</title>
	...
	<div role="main" class="ui-content jqm-content">
		...
		<div data-demo-html="true">
			<div class="ui-rtl" dir="rtl">
				<form>
					<label for="flip-1r">Flip toggle switch:</label>
					<select id="flip-1r" name="flip-1r" data-role="slider">
		...
		<p>LTR basic in a RTL context.</p>
		...
		<div data-demo-html="true">
			<div class="ui-rtl" dir="rtl">
				<form>
					<label for="flip-2r">Flip toggle switch:</label>
					<select name="flip-2r" id="flip-2r" data-role="slider" data-track-theme="b" data-theme="b">
						<option value="off">Off</option>
						<option value="on">On</option>
					</select>
				</form>
		...
		<div data-demo-html="true">
			<div class="ui-rtl" dir="rtl">
				<form>
					<label for="flip-3r">Flip toggle switch:</label>
					<select name="flip-3r" id="flip-3r" data-role="slider" data-mini="true">
						<option value="off">Off</option>
						<option value="on">On</option>
					</select>
				</form>
		...
		<div data-demo-html="true">
			<div class="ui-rtl" dir="rtl">
				<form>
					<label for="flip-4r">Flip toggle switch:</label>
					<select name="flip-4r" id="flip-4r" data-role="slider" disabled="disabled">
						<option value="off">Off</option>
						<option value="on">On</option>
					</select>
				</form>
		...
		<div data-demo-html="true">
			<div class="ui-rtl" dir="rtl">
				<form>
					<label for="flip-5r" class="ui-hidden-accessible">Flip toggle switch:</label>
					<select name="flip-5r" id="flip-5r" data-role="slider">
						<option value="off">Off</option>
						<option value="on">On</option>
					</select>
				</form>
			...
			<div class="ui-rtl" dir="rtl">
				<form>
					<div class="ui-field-contain">
						...
						<select name="flip-6r" id="flip-6r" data-role="slider">
							<option value="off">Off</option>
							<option value="on">On</option>
						</select>
					</div>
		...
		<div data-demo-html="true">
			<div class="ui-rtl" dir="rtl">
				<form>
					<div class="ui-field-contain">
						<label for="flip-7r">Flip toggle switch:</label>
						<select name="flip-7r" id="flip-7r" data-role="slider" data-mini="true">
							<option value="off">Off</option>
							<option value="on">On</option>
						</select>
					</div>
