...
<html>
	...
	<title>RTL Persistent toolbars - jQuery Mobile Demos</title>
...
<body>
	...
	<div data-role="header" data-position="fixed" data-theme="a" class="ui-rtl" dir="rtl">
	...
	<div data-role="page" data-title="Info" class="jqm-demos">
	    ...
	    <div role="main" class="ui-content jqm-content jqm-fullwidth">
			...
			<h1>RTL Persistent toolbars</h1>

			<p>These pages are a demo of a persistent <a href="../rtl-navbar/">navbar</a> in a fixed footer toolbar. Click on any of the links in the footer, and you'll see the page content transition. Both the persistent header and footer on these pages remain in place during the animation to a new HTML page.</p>
	...
	<div data-role="footer" data-position="fixed" data-theme="a" class="ui-rtl" dir="rtl">
