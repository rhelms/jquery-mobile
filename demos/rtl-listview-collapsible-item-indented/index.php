...
<head>
    ...
    <title>RTL Listviews indented collapsible list items - jQuery Mobile Demos</title>
    ...
    <style id="collapsible-list-item-style">
        ...
        .ui-rtl .ui-li-static.ui-collapsible > .ui-collapsible-content {
            padding-top: 0;
            padding-bottom: 0;
            padding-left: 0;
        ...
        .ui-rtl .ui-ltr .ui-li-static.ui-collapsible > .ui-collapsible-content {
            padding-left: 1em;
            padding-right: 0;
        }
        ...
        .ui-rtl .ui-li-static.ui-collapsible > .ui-collapsible-content > .ui-listview > .ui-li-static,
        .ui-rtl .ui-li-static.ui-collapsible > .ui-collapsible-content > .ui-listview > li > a.ui-btn {
            border-right-width: 1px;
            border-left-width: 0;
        }

        .ui-rtl .ui-ltr .ui-li-static.ui-collapsible > .ui-collapsible-content > .ui-listview > .ui-li-static,
        .ui-rtl .ui-ltr .ui-li-static.ui-collapsible > .ui-collapsible-content > .ui-listview > li > a.ui-btn {
            border-right-width: 0;
...
<div data-role="page" class="jqm-demos" data-quicklinks="true">
    ...
    <div role="main" class="ui-content jqm-content">
        ...
        <h1>RTL Indented collapsible list items</h1>

        <p>You can create indented collapsible list items by instantiating collapsible widgets on them and adding some
            custom CSS to collapse borders and padding. In all the examples below, the outermost listview has class
            <code>ui-listview-outer</code> to identify it as the outermost listview in the tree structure of indented
            lists.</p>
        ...
        <p>LTR regular listview in a RTL context</p>
