...
<head>
    ...
    <title>RTL Listviews collapsible list items - jQuery Mobile Demos</title>
...
<div data-role="page" class="jqm-demos" data-quicklinks="true">
    ...
    <div role="main" class="ui-content jqm-content">
        ...
        <h1>RTL Collapsible list items</h1>

        <p>You can create collapsible list items by instantiating collapsible widgets on them and adding some custom CSS
            to collapse borders and padding.</p>
