...
<head>
	...
	<title>RTL Table Column toggle demo: Phone comparison - jQuery Mobile Demos</title>
	...
	<div role="main" class="ui-content jqm-content">
		...
		<div data-demo-html="true" data-demo-css="true">
			<div class="ui-rtl" dir="rtl">
				...
				<table data-role="table" id="phone-table-r" data-mode="columntoggle" data-column-btn-text="Compare..." data-column-btn-theme="a" class="phone-compare ui-shadow table-stroke">
              <thead>
                <tr>
              ...
              <tbody>
                <tr class="photos">
                  ...
                  <td><a href="#img-iphone5-r" data-rel="popup" data-position-to="window"><img src="../_assets/img/phone_iphone5.png"></a></td>
                  <td><a href="#img-galaxy-r" data-rel="popup" data-position-to="window"><img src="../_assets/img/phone_galaxy3.png"></a></td>
                  <td><a href="#img-lumia-r" data-rel="popup" data-position-to="window"><img src="../_assets/img/phone_lumia920.png"></a></td>
                  <td><a href="#img-onex-r" data-rel="popup" data-position-to="window"><img src="../_assets/img/phone_onex.png"></a></td>
                </tr>
                <tr>
			...
			<div id="img-iphone5-r" data-role="popup" data-overlay-theme="a">
				<img src="../_assets/img/phone_iphone5.png">
			</div>

			<div id="img-galaxy-r" data-role="popup" data-overlay-theme="a">
				<img src="../_assets/img/phone_galaxy3.png">
			</div>

			<div id="img-lumia-r" data-role="popup" data-overlay-theme="a">
				<img src="../_assets/img/phone_lumia920.png">
			</div>

			<div id="img-onex-r" data-role="popup" data-overlay-theme="a">
				<img src="../_assets/img/phone_onex.png">
			</div>

		</div><!-- /data-demo -->

		<p>LTR Popular Phones in a RTL context</p>
