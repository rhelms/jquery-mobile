...
<html>
	...
	<title>RTL Popup - jQuery Mobile Demos</title>
...
<div data-role="page" class="jqm-demos" data-quicklinks="true">
	...
	<div role="main" class="ui-content jqm-content">
		...
		<div data-demo-html="true">
			...
			<div data-role="popup" id="popupBasic" class="ui-rtl" dir="rtl">
			<p>This is a completely basic popup, no options set, except to display as RTL.</p>
			</div>
		</div><!--/demo-html -->
		...
		<div data-demo-html="true" data-demo-css="#tooltip-btn">
			...
			<div data-role="popup" id="popupInfo" class="ui-content ui-rtl" data-theme="a" style="max-width:350px;" dir="rtl">
		...
		<div data-demo-html="true">
			...
			<div data-role="popup" id="popupParis" data-overlay-theme="b" data-theme="b" data-corners="false" class="ui-rtl" dir="rtl">
				<a href="#" data-rel="back" class="ui-btn ui-corner-all ui-shadow ui-btn-a ui-icon-delete ui-btn-icon-notext ui-btn-left">Close</a><img class="popphoto" src="../_assets/img/paris.jpg" style="max-height:512px;" alt="Paris, France">
			</div>
			<div data-role="popup" id="popupSydney" data-overlay-theme="b" data-theme="b" data-corners="false" class="ui-rtl" dir="rtl">
				<a href="#" data-rel="back" class="ui-btn ui-corner-all ui-shadow ui-btn-a ui-icon-delete ui-btn-icon-notext ui-btn-left">Close</a><img class="popphoto" src="../_assets/img/sydney.jpg" style="max-height:512px;" alt="Sydney, Australia">
			</div>
			<div data-role="popup" id="popupNYC" data-overlay-theme="b" data-theme="b" data-corners="false" class="ui-rtl" dir="rtl">
				<a href="#" data-rel="back" class="ui-btn ui-corner-all ui-shadow ui-btn-a ui-icon-delete ui-btn-icon-notext ui-btn-left">Close</a><img class="popphoto" src="../_assets/img/newyork.jpg" style="max-height:512px;" alt="New York, USA">
			</div>
		</div><!--/demo-html -->
		...
		<div data-demo-html="true">
			...
			<div data-role="popup" id="popupMenu" data-theme="b" class="ui-rtl" dir="rtl">
		...
		<div data-demo-html="true">
			...
			<div data-role="popup" id="popupNested" data-theme="none" class="ui-rtl" dir="rtl">
				<div data-role="collapsibleset" data-theme="b" data-content-theme="a" data-collapsed-icon="arrow-l" data-expanded-icon="arrow-d" style="margin:0; width:250px;">
		...
		<div data-demo-html="true">
			...
			<div data-role="popup" id="popupLogin" data-theme="a" class="ui-corner-all ui-rtl" dir="rtl">
				<form>
		...
		<div data-demo-html="true">
			...
			<div data-role="popup" id="popupDialog" data-overlay-theme="b" data-theme="b" data-dismissible="false" style="max-width:400px;" class="ui-rtl" dir="rtl">
		...
		<div data-demo-html="true">
			...
			<div data-role="popup" id="popupPadded" class="ui-content ui-rtl" dir="rtl">
		...
		<div data-demo-html="true">
			...
			<div data-role="popup" id="popupCloseRight" class="ui-content ui-rtl" style="max-width:280px" dir="rtl">
				<a href="#" data-rel="back" class="ui-btn ui-corner-all ui-shadow ui-btn-a ui-icon-delete ui-btn-icon-notext ui-btn-right">Close</a>
			<p>I have a close button at the top right corner with simple HTML markup.</p>
			</div>

			<div data-role="popup" id="popupCloseLeft" class="ui-content ui-rtl" style="max-width:280px" dir="rtl">
				<a href="#" data-rel="back" class="ui-btn ui-corner-all ui-shadow ui-btn-a ui-icon-delete ui-btn-icon-notext ui-btn-left">Close</a>
			<p>I have a close button at the top left corner with simple HTML markup.</p>
			</div>

			<div data-role="popup" id="popupUndismissible" class="ui-content ui-rtl" style="max-width:280px" data-dismissible="false" dir="rtl">
				<a href="#" data-rel="back" class="ui-btn ui-corner-all ui-shadow ui-btn-a ui-icon-delete ui-btn-icon-notext ui-btn-left">Close</a>
		...
		<div data-demo-html="true">
			...
			<div data-role="popup" id="positionWindow" class="ui-content ui-rtl" data-theme="a" dir="rtl">
			<p>I am positioned to the window.</p>
			</div>

			<div data-role="popup" id="positionOrigin" class="ui-content ui-rtl" data-theme="a" dir="rtl">
			<p>I am positioned over the origin.</p>
			</div>

			<div data-role="popup" id="positionSelector" class="ui-content ui-rtl" data-theme="a" dir="rtl">
		...
		<div data-demo-html="true">
			...
			<div data-role="popup" id="transitionExample" class="ui-content ui-rtl" data-theme="a" dir="rtl">
		...
		<div data-demo-html="true">
			...
			<div id="theme" data-role="popup" data-theme="a" class="ui-content ui-rtl" dir="rtl">
			...
			<div id="transparent" data-role="popup" data-theme="none" data-shadow="false" class="ui-rtl" dir="rtl">
				<a href="#" data-rel="back" class="ui-btn ui-corner-all ui-shadow ui-btn-a ui-icon-delete ui-btn-icon-notext ui-btn-right">Close</a>
			...
			<div id="overlay" data-role="popup" data-overlay-theme="a" class="ui-content ui-rtl" dir="rtl">
			...
			<div id="both" data-role="popup" data-overlay-theme="a" data-theme="b" class="ui-content ui-rtl" dir="rtl">
		...
		<p>Click in the pink area below to display a popup with an arrow.</p>
			<div data-demo-html="true" data-demo-css="#popup-arrow-css" data-demo-js="#popup-arrow-script">
				<div data-role="popup" id="popupArrow" data-arrow="true" class="ui-rtl" dir="rtl">
...
<?php include( '../jqm-search.php' ); ?>
	...
	<div id="pre-rendered-page" data-role="page">
		...
		<div id="pre-rendered-popup" class="ui-popup-container fade ui-popup-hidden ui-body-inherit ui-overlay-shadow ui-corner-all">
			<div id="pre-rendered" class="ui-popup ui-rtl" data-role="popup" data-enhanced="true" data-transition="fade" dir="rtl">
