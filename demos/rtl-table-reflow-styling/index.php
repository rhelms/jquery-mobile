...
<head>
	...
	<title>RTL Table Reflow: Custom styles - jQuery Mobile Demos</title>
	...
	<style>
		...
		.ui-rtl .movie-list tbody td.title {
			padding-left: .5em;
			padding-right: .8em;
		}
		.ui-rtl .ui-ltr .movie-list tbody td.title {
			padding-left: .8em;
			padding-right: .5em;
		}
		/* Add strokes */
		...
		@media ( max-width: 40em ) {
			...
			.ui-rtl .movie-list td,
			.ui-rtl .movie-list th {
				float: right;
				clear: right;
			}

			.ui-rtl .ui-ltr .movie-list td,
			.ui-rtl .ui-ltr .movie-list th {
				float: left;
				clear: left;
			}
		}
...
<div data-role="page" class="jqm-demos">
	...
	<div role="main" class="ui-content jqm-content">
		...
		<h1>RTL Table Reflow: Custom styles</h1>

		<p>Custom styles for the reflow table at stacked widths.</p>

        <h3>RTL Top Movies</h3>

		<div data-demo-html="true" data-demo-css="true">
			<div class="ui-rtl" dir="rtl">
            	<table data-role="table" id="movie-table-custom-r" data-mode="reflow" class="movie-list">
              <thead>
                <tr>
		...
		<p>LTR Top Movies in a RTL context</p>
