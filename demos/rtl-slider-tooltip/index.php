...
<head>
	...
	<title>RTL Slider Tooltip Extension - jQuery Mobile Demos</title>
...
<div data-role="page" class="jqm-demos">
	...
	<div role="main" class="ui-content jqm-content">
		...
		<h1>RTL Slider tooltip extension</h1>

		<div data-demo-html="true">
			<div class="ui-rtl" dir="rtl">
				<form>
					<label for="slider-1r">Slider with tooltip:</label>
					<input type="range" name="slider-1r" id="slider-1r" min="0" max="100" value="50"
						   data-popup-enabled="true">
					<label for="slider-2r">Slider showing value on button:</label>
					<input type="range" name="slider-2r" id="slider-2r" min="0" max="100" value="50"
						   data-show-value="true">
					<label for="slider-3r">Both options together:</label>
					<input type="range" name="slider-3r" id="slider-3r" min="0" max="100" value="50"
						   data-show-value="true" data-popup-enabled="true">
					<label for="slider-3r">Both options together (mini):</label>
					<input type="range" name="slider-3r" id="slider-3r" min="0" max="100" value="50"
						   data-show-value="true" data-popup-enabled="true" data-mini="true">
				</form>
			</div>
		</div>
		<!-- /demo-html -->

		<p>LTR slider tooltip in a RTL context</p>
