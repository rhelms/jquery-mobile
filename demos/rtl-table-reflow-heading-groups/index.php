...
<head>
	...
	<title>RTL Table Reflow: Heading groups - jQuery Mobile Demos</title>
	...
	<style>
		...
		@media (max-width: 72em) {
			...
			.ui-rtl .financial-table-reflow td,
			.ui-rtl .financial-table-reflow th {
				float: right;
				clear: right;
			}

			.ui-rtl .ui-ltr .financial-table-reflow td,
			.ui-rtl .ui-ltr .financial-table-reflow th {
				float: left;
				clear: left;
			}
		}
...
<div data-role="page" class="jqm-demos">
	...
	<div role="main" class="ui-content jqm-content">
        ...
        <h1>RTL Table Reflow: Heading groups</h1>


        <div data-demo-html="true" data-demo-css="true">
			<div class="ui-rtl" dir="rtl">

        		<table data-role="table" id="financial-table-reflow-r" data-mode="reflow" class="financial-table-reflow table-stroke">
				<thead>
					<tr class="th-groups">
						<th></th>
		...
		<p>LTR Table Reflow: Heading groups in a RTL context</p>
