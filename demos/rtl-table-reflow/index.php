...
<html>
	...
	<title>RTL Table: Reflow - jQuery Mobile Demos</title>
...
<div data-role="page" class="jqm-demos" data-quicklinks="true">
	...
	<div class="ui-content jqm-content" role="main">
		...
		<h1>RTL Table: Reflow</h1>

		<h2>Reflow basics</h2>

		<div data-demo-html="true">
			<div class="ui-rtl" dir="rtl">
		    	<table data-role="table" id="movie-table-r" data-mode="reflow" class="ui-responsive">
		      <thead>
		        <tr>
		...
		<p>LTR Reflow basis in a RTL context</p>
		...
		<h2>RTL Grouped column headers</h2>

		<div data-demo-html="true">
			<div class="ui-rtl" dir="rtl">
			    <table data-role="table" id="temp-table-r" data-mode="reflow" class="ui-responsive table-stroke">
			<thead>
				<tr>
		...
		<p>LTR Grouped column headers in a RTL context</p>
