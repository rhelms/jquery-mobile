...
<html>
	...
	<title>RTL Fullscreen Fixed toolbars - jQuery Mobile Framework</title>
...
<body>
	...
	<div data-role="page" class="jqm-demos">
			...
			<div data-role="header" data-position="fixed" data-fullscreen="true"  class="ui-rtl" dir="rtl">
	    ...
	    <div class="ui-content" role="main">
			...
			<div class="jqm-content" style="margin-bottom:3em;">
				<p>This page demonstrates the "fullscreen" toolbar mode with RTL aspects. This toolbar treatment is used in special cases where you want the content to fill the whole screen, and you want the header and footer toolbars to appear and disappear when the page is clicked responsively &mdash; a common scenario for photo, image or video viewers.</p>
		...
		<div data-role="footer" data-theme="a" data-position="fixed" data-fullscreen="true"  class="ui-rtl" dir="rtl">
