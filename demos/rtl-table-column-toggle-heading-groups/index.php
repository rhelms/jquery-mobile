...
<head>
	...
	<title>RTL Table Column toggle: Heading groups - jQuery Mobile Demos</title>
...
<div data-role="page" class="jqm-demos">
	...
	<div role="main" class="ui-content jqm-content">
        ...
        <h1>RTL Table Column toggle: Heading groups</h1>

        <div data-demo-html="true" data-demo-css="true">
			<div class="ui-rtl" dir="rtl">
         		<table data-role="table" id="financial-table-r" data-column-btn-theme="b" data-column-popup-theme="a" data-mode="columntoggle" class="table-stroke">
				<thead>
					<tr class="th-groups">
						<td></td>
		...
		<p>LTR Table Column toggle : Heading groups in a RTL context</p>
