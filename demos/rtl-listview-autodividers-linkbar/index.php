...
<head>
	...
	<title>RTL Listview Autodivider Linkbar - jQuery Mobile Demos</title>
...
<div data-role="page" class="jqm-demos">
	...
	<div role="main" class="ui-content jqm-content">
		...
		<h1>RTL Listview Autodivider Linkbar</h1>

		<p>This demo shows the linkbar extension that adds a fixed positioned bar on the left of the screen that makes it easy to anchor down to a specific part of a listview. View the source to see how it works.</p>

        <p>This is similar to the LTR example</p>
